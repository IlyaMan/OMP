...
#### График времени работы алгорима в секундах на матрице 200x200 по [таблице 1](#200-time-table)
![200x chart](report_images/200x_time.png)

#### График ускорения алгорима на матрице 200x200 по [таблице 2](#200-acceleration-table)
![200x acceleration chart](report_images/200x_acceleration.png)

#### График времени работы алгорима в секундах на матрице 5000x5000 по [таблице 3](#5000-time-table)
![5000x time chart](report_images/5000x_time.png)



#### График ускорения алгорима на матрице 5000x5000 по [таблице 4](#5000-acceleration-table)
